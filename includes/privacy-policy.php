<?php
// includes/privacy-policy.php - Privacy Policy Page
include "header.php";
?>
<style>
    ...
    if (backLink) {
        backLink.addEventListener('click', function(e) {
            ...
            if (document.referrer && document.referrer !== window.location.href) {
                ...
                window.location.href = '<?php echo isset($_SESSION["user_id"]) ? (($_SESSION["role"] === "admin") ? "admin_dashboard.php" : "player/player_dashboard.php") : "../index.php"; ?>';
            }
        });
    }
});
