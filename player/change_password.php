        ...
        try {
            ...
            if ($user && password_verify($current_password, $user['password'])) {
                ...
                try {
                    ...
                    $player_device_ids = getPlayerIdsForUser($pdo, $user_id);
                    
                    if (!empty($player_device_ids)) {
                        sendOneSignalNotification(
                            $player_device_ids,
                            "Dear $player_name, Your password was changed successfully! 🔐",
                    ...
                    error_log("Password Change Notification Error: " . $no_err->getMessage());
                }
            } else {
...
<style>
    ...
    .page-bg {
        ...
        height: 100%;
        z-index: -1;
        background: linear-gradient(45deg, #e0f2fe, #f0f9ff, #bae6fd);
            ...
            <form method="POST" id="changePasswordForm" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="password" class="form-control-custom" id="current_password" name="current_password"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        ...
                        <input type="password" class="form-control-custom" id="new_password" name="new_password"
                            placeholder="Create new password" required minlength="6">
                ...
                <div class="guidelines-box">
                    <div class="guideline-item" id="rule-length"><i class="fas fa-circle"></i> At least 6 characters
                    </div>
